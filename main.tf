...
module "crds" {
  ...
  crds_urls = [
    "https://cdn.jsdelivr.net/gh/kubernetes-sigs/aws-load-balancer-controller@${var.image_tag}/helm/aws-load-balancer-controller/crds/crds.yaml",
    "https://cdn.jsdelivr.net/gh/kubernetes-sigs/aws-load-balancer-controller@${var.image_tag}/helm/aws-load-balancer-controller/crds/gateway-crds.yaml",
  ]
}
