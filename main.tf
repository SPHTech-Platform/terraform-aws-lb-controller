...
module "crds" {
  ...
  crds_urls = [
    ...
    "https://raw.githubusercontent.com/kubernetes-sigs/aws-load-balancer-controller/refs/tags/${var.image_tag}/helm/aws-load-balancer-controller/crds/gateway-crds.yaml",
  ]
}
